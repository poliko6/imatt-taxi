...
$cus_calltaxi_data = count_data_mysql('historyId','driverhistory',"statusWork != '99' AND statusWork != '88' AND statusWork != '5' AND statusWork != '6' AND statusWork != '7' order by callTime DESC");
