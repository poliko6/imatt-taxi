<table class="table table-striped table-bordered table-condensed">
  <tr>
    <td width="5%" align="center"><img src="modules/mod_taxi/images/taximanage-icon.png" alt="" width="50" height="50" /></td>
    <td width="29%"><a href="index.php?p=taxi.taximanage&menu=main_taxi" style="text-decoration:none;"><?=$lang_menu["menu_taxi_manage"]?></a><br />
		<span class="normal">เมนูเพิ่ม แก้ไข และลบ รายละเีอียดรถแท๊กซี่ในระบบ</span></td>
