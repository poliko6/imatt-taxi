										...
										<div class="tab-pane" id="mbox_new">
											<form id="new_message_form">
												<div class="sepH_b">
													...
													<select name="mail_sender" id="mail_sender">
												...
												<div class="sepH_c">
													...
													<a class="add_files" href="#">Add files</a>
												...
												<div class="formSep">
													<label for="mail_message">Subject</label>
											...
											<table data-msg_rowlink="a" class="table table_vam mbox_table dTableR" id="dt_outbox">
												...
												<tbody>
													<tr>
														...
														<td><span>email_19@example.com</span></td>
														<td>9/04/2012</td>
														<td>1058 KB</td>
														<td></td>
													</tr>
													...
													<tr>
														...
														<td><i class="splashy-mail_light_right"></i></td>
														<td><a href="#msg_view">Lorem ipsum dolor sit amet c…</a></td>
														<td><span>email_28@example.com</span></td>
														<td>25/05/2012</td>
														<td>688 KB</td>
														<td></td>
													</tr>
													...
													<tr>
														...
														<td><i class="splashy-mail_light_right"></i></td>
														<td><a href="#msg_view">Lorem ipsum dolor sit amet con…</a></td>
														<td><span>email_13@example.com</span></td>
														<td>11/03/2012</td>
														<td>334 KB</td>
														<td></td>
													</tr>
											...
											<table data-msg_rowlink="a" class="table table_vam mbox_table dTableR" id="dt_trash">
												...
												<tbody>
													...
													<tr>
														...
														<td><i class="splashy-mail_light_stuffed"></i></td>
														<td><a href="#msg_view">Lorem ipsum dolor sit amet co…</a></td>
														<td><span>email_1@example.com</span></td>
														<td>20/04/2012</td>
														<td>879 KB</td>
														<td><i class="icon-adt_atach"></i></td>
													</tr>
													...
													<tr>
														...
														<td><i class="splashy-mail_light_stuffed"></i></td>
														<td><a href="#msg_view">Lorem ipsum dolor sit amet consecte…</a></td>
														<td><span>email_16@example.com</span></td>
														<td>11/06/2012</td>
														<td>362 KB</td>
														<td></td>
													</tr>
													<tr>
														...
														<td><i class="splashy-mail_light_stuffed"></i></td>
														<td><a href="#msg_view">Lorem ipsum dolor sit amet co…</a></td>
														<td><span>email_4@example.com</span></td>
														<td>12/03/2012</td>
														<td>281 KB</td>
														<td></td>
													</tr>
													...
													<tr>
														...
														<td><i class="splashy-mail_light_stuffed"></i></td>
														<td><a href="#msg_view">Lorem ipsum dolor sit amet co…</a></td>
														<td><span>email_21@example.com</span></td>
														<td>25/04/2012</td>
														<td>814 KB</td>
														<td></td>
													</tr>
													...
													<tr>
														...
														<td><i class="splashy-mail_light_stuffed"></i></td>
														<td><a href="#msg_view">Lorem ipsum dolor sit amet …</a></td>
														<td><span>email_25@example.com</span></td>
														<td>10/05/2012</td>
														<td>1401 KB</td>
														<td></td>
													</tr>
	...
	<div class="span12">
        <div class="well clearfix">
            <div class="row-fluid">
                ...
                <div class="pull-right">
                  <button class="btn btn-success" onClick="">เพิ่มประเภทรถ</button>  
                </div>
            </div>
        </div>
		<? if ($total != 0){ ?>
