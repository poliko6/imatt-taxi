<table class="table table-striped table-bordered table-condensed">
  <tr>
    <td width="5%" align="center"><img src="modules/mod_car/images/fuel-icon.png" alt="" width="50" height="50" /></td>
    <td width="29%"><a href="index.php?p=car.fuel&menu=main_car" style="text-decoration:none;"><?=$lang_menu["menu_car_fuel"]?></a><br />
