...
<script type="text/javascript">
	...
	function fn_formDel(id){
		jQuery.ajax({
			url :'modules/mod_car/banner/delfuel.php',
			type: 'GET',
	...
	function fn_formAdd(){		
		if ($('#fuel_name').val() == ''){
			...
			//$('#fm_addfuel').submit();			
			jQuery.ajax({
   				url :'modules/mod_car/banner/addfuel.php',
   				type: 'GET',
	...
	function fn_formEdit(id,process){
		...
		if (process == 'select') {
			$.post("modules/mod_car/banner/getfuel.php", { 
					process: process,
					id: id
				}, 
				function(data){
		...
		if (process == 'update') {
			...
			if ($('#fuel_name_edit').val() == ''){
				...
				jQuery.ajax({
					url :'modules/mod_car/banner/editfuel.php',
					type: 'GET',
...
<div class="modal hide fade" id="myModalAdd">
    ...
    <div class="modal-body">
        <div class="formSep">
            ...
            <span class="help-block" id="errtxt" style="color:#900; display:none;">กรุณาป้อนประเภทเชื้อเพลิงรถ</span>
        </div> 
    </div>
...
<div class="modal hide fade" id="myModalEdit">
    ...
    <div class="modal-body">
        <div class="formSep">
            ...
            <span class="help-inline">ตัวอย่าง : ประเภทเชื้อเพลิงแดง</span>
            <span class="help-block" id="errtxt_edit" style="color:#900; display:none;">กรุณาป้อนประเภทเชื้อเพลิงรถ</span>
        </div> 
    </div>
    <div class="modal-footer">        
    	<!--<input type="submit" name="submit_add" id="submit_add"  class="btn btn-primary" value="บันทึก" /> -->
            ...
            <div class="row-fluid">
                ...
                <div class="pull-right">
                  <a data-toggle="modal" data-backdrop="static" href="#myModalAdd">
                  	<button class="btn btn-success" onClick="">เพิ่มประเภทเชื้อเพลิงรถ</button></a>  
                </div>
            </div>
        </div>
