<table class="table table-striped table-bordered table-condensed">
            ...
            <div class="span12">
                <div class="span1" style="text-align:center;">
                	<div style="border:1px solid #CCC;">
                    	<img src="modules/mod_blog/images/banner-icon.png" alt="" width="50" height="50" />
                    </div>
                </div>
                <div class="span4">
                    <div><a href="index.php?p=blog.banner&menu=main_blog" style="text-decoration:none;"><?=$lang_menu["blog.banner"]?></a></div>
                    <div class="normal">เมนูแก้ไข ปรับแต่งโลโก และป้ายโฆษณาอู่รถ</div>
                </div>
                <div class="span7">
  ...
  <tr>
	...
	<?
	if ($handle_banner = opendir('modules/mod_blog/banner')) {
	...
	{		
		...
		if($file_menu_banner[$ii_banner]){
			include("modules/mod_blog/banner/$file_menu_banner[$ii_banner]");									
		}
	}	
	?>
    </td>
