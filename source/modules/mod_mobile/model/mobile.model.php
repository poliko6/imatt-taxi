<table class="table table-striped table-bordered table-condensed">
            ...
            <div class="span12">
                <div class="span1" style="text-align:center;">
                	<div style="border:1px solid #CCC;">
                    	<img src="modules/mod_mobile/images/model-icon.png" alt="" width="50" height="50" />
                    </div>
                </div>
                <div class="span4">
                    <div><a href="index.php?p=mobile.model&menu=main_mobile" style="text-decoration:none;"><?=$lang_menu["mobile.model"]?></a></div>
                    <div class="normal">เมนูเพิ่ม แก้ไข และลบ รุ่นมือถือ</div>
                </div>
                <div class="span7">
  ...
  <tr>
	...
	<?
	if ($handle_model = opendir('modules/mod_mobile/model')) {
	...
	{		
		...
		if($file_menu_model[$ii_model]){
			include("modules/mod_mobile/model/$file_menu_model[$ii_model]");									
		}
	}	
	?>
    </td>
